...
| 2.2 | Integration tests — Round-trip ETL → code lookup → Arrow export | Test loads MIMIC CSV → transforms to Arrow → looks up codes → validates schema round-trip; tests pass with real data sample | - | cc:WIP |
