...
| 2.4 | MSRV bump candidate — Evaluate 1.95+ once stable | Research Rust 1.95 compatibility; identify breaking changes if any; update MSRV in Cargo.toml if feasible | - | cc:completed [5fc3bdf] |
